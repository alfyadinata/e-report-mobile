...
const ProfileIcon = (style) => <Icon {...style} name="menu-outline" />;

const NotifyIcon = (style) => <Icon {...style} name="bell-outline" />;

const ReportIcon = (style) => <Icon {...style} name="book-outline" />;
